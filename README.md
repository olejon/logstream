...
**Note:** Current script on my server uses an API that only supports IPv4 addresses. [Direct link to JavaScript Geolocation function](https://github.com/olejon/logstream/blob/703fd14ce8b8a0f137c42e1d1fb53988c4a01014/logstream/js/main.js#L187).
